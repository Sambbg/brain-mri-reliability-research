...
def main():
    ...
    with REPORT_PATH.open("w", encoding="utf-8") as f:
        f.write("# E003 - Calibration Evaluation Results\n\n")

        f.write("## Experiment\n\n")
        f.write("E003 - D1 ViT-B/16 internal leakage-aware baseline\n\n")
        ...
        f.write("\n## Interpretation\n\n")
        f.write(
            "This calibration evaluation measures whether the ViT-B/16 model's predicted confidence "
