...
REPORT_PATH = Path("reports/experiments/E001_D3C_domain_shift_results.md")
...
def write_report(metrics, pred_df):
    ...
    with REPORT_PATH.open("w", encoding="utf-8") as f:
        f.write("# E001 on D3C Domain-Shift Evaluation\n\n")

        f.write("## Experiment\n\n")
        f.write("E001 ResNet18 trained on D1 leakage-aware split, evaluated on D3C UPENN-GBM central slices.\n\n")
        ...
        f.write("\n## Interpretation\n\n")
        f.write(
            "This report evaluates whether the D1-trained E001 model recognises D3C glioma-domain images "
        ...
        f.write(
            "The next step is to apply the E001 temperature scaling parameter to these D3C logits/probabilities "
