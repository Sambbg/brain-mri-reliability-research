...
PREDICTIONS_CSV = Path("experiments/E002_D1_resnet18_baseline/d3b_predictions.csv")
TEMP_METRICS_JSON = Path("experiments/E002_D1_resnet18_baseline/temperature_scaling_metrics.json")

OUT_PREDICTIONS_CSV = Path("experiments/E002_D1_resnet18_baseline/d3b_temperature_scaled_predictions.csv")
OUT_METRICS_JSON = Path("experiments/E002_D1_resnet18_baseline/d3b_temperature_scaled_metrics.json")
...
def write_report(temperature, raw_metrics, scaled_metrics):
    ...
    with REPORT_PATH.open("w", encoding="utf-8") as f:
        f.write("# E002 on D3B — Temperature-Scaled Domain-Shift Evaluation\n\n")
