...
PREDICTIONS_CSV = Path("experiments/E002_D1_efficientnet_b0_baseline/d3c_predictions.csv")
TEMP_METRICS_JSON = Path("experiments/E002_D1_efficientnet_b0_baseline/temperature_scaling_metrics.json")

OUT_PREDICTIONS_CSV = Path("experiments/E002_D1_efficientnet_b0_baseline/d3c_temperature_scaled_predictions.csv")
OUT_METRICS_JSON = Path("experiments/E002_D1_efficientnet_b0_baseline/d3c_temperature_scaled_metrics.json")
