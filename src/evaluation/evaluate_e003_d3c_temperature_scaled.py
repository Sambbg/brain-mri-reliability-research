...
PREDICTIONS_CSV = Path(f"experiments/E003_D1_vit_b16_baseline/{SEED_SUBDIR}/d3c_predictions.csv")
TEMP_METRICS_JSON = Path(f"experiments/E003_D1_vit_b16_baseline/{SEED_SUBDIR}/temperature_scaling_metrics.json")

OUT_PREDICTIONS_CSV = Path(f"experiments/E003_D1_vit_b16_baseline/{SEED_SUBDIR}/d3c_temperature_scaled_predictions.csv")
OUT_METRICS_JSON = Path(f"experiments/E003_D1_vit_b16_baseline/{SEED_SUBDIR}/d3c_temperature_scaled_metrics.json")
REPORT_PATH = Path("reports/experiments/E003_D3C_temperature_scaled_results.md")
...
def write_report(temperature, raw_metrics, scaled_metrics):
    ...
    with REPORT_PATH.open("w", encoding="utf-8") as f:
        f.write("# E003 on D3C — Temperature-Scaled Domain-Shift Evaluation\n\n")

        f.write("## Experiment\n\n")
        f.write(
            "E003 ViT-B/16 trained on D1, evaluated on D3C UPENN-GBM central slices. "
