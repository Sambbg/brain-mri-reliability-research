...
PREDICTIONS_CSV = Path("experiments/E003_D1_vit_b16_baseline/d3c_predictions.csv")
TEMP_METRICS_JSON = Path("experiments/E003_D1_vit_b16_baseline/temperature_scaling_metrics.json")

OUT_PREDICTIONS_CSV = Path("experiments/E003_D1_vit_b16_baseline/d3c_temperature_scaled_predictions.csv")
OUT_METRICS_JSON = Path("experiments/E003_D1_vit_b16_baseline/d3c_temperature_scaled_metrics.json")
