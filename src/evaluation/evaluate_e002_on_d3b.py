...
REPORT_PATH = Path("reports/experiments/E002_D3B_domain_shift_results.md")
...
def write_report(metrics, pred_df):
    ...
    with REPORT_PATH.open("w", encoding="utf-8") as f:
        f.write("# E002 on D3B Domain-Shift Evaluation\n\n")

        f.write("## Experiment\n\n")
        f.write("E002 EfficientNet-B0 trained on D1 leakage-aware split, evaluated on D3B ICDC-Glioma central slices.\n\n")
        ...
        f.write("\n## Interpretation\n\n")
        f.write(
            "This report evaluates whether the D1-trained E002 model recognises D3B glioma-domain images "
        ...
        f.write(
            "The next step is to apply the E002 temperature scaling parameter to these D3B logits/probabilities "
