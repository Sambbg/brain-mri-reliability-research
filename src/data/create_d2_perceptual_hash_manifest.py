...
IN_PATH = Path("data/processed/D2_manifest_deduplicated.csv")
OUT_PATH = Path("data/processed/D2_manifest_deduplicated_phash.csv")
REPORT_PATH = Path("reports/datasets/D2_perceptual_hash_report.md")
...
def main():
    ...
    with REPORT_PATH.open("w", encoding="utf-8") as f:
        f.write("# D2 Perceptual Hash Report\n\n")
        ...
        f.write(
            "This report adds perceptual hash values to the exact-deduplicated D2 manifest. "
            "The next step is to compare pHash Hamming distances to identify near-duplicate image pairs "
            "within D2 and then compare D2 against D1 to detect possible dataset overlap.\n"
        )
