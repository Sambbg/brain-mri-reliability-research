...
INPUT_MANIFEST = Path("data/processed/D3C_selected_slices_manifest.csv")
OUTPUT_MANIFEST = Path("data/processed/D3C_selected_slices_manifest_phash.csv")
REPORT_PATH = Path("reports/datasets/D3C_perceptual_hash_report.md")
...
def main():
    ...
    with REPORT_PATH.open("w", encoding="utf-8") as f:
        f.write("# D3C Perceptual Hash Report\n\n")
        ...
        f.write(
            "This report adds exact and perceptual hashes to the D3C converted central-slice manifest. "
            "The next step is to compare D3C against D1 using exact SHA256 overlap and pHash near-overlap checks. "
            "This is required before using D3C for domain-shift evaluation.\n"
        )
